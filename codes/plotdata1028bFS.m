...
d2 = [];
for ii = 1:4
    if     ii == 1, saliency = data.saliency.full;
    elseif ii == 2, saliency = data.saliency.color;
    elseif ii == 3, saliency = data.saliency.luminance;
    elseif ii == 4, saliency = data.saliency.orientation;
    end
