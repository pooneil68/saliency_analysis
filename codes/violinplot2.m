function violins2 = violinplot2(data, cats, varargin)
...
% Modified by Masatoshi Yoshida 20211008
    ...
    if isa(data, 'dataset') || isstruct(data) || istable(data)
        ...
        for n=1:length(catnames)
            ...
            violins2(n) = Violin2(thisData, n, varargin{:});
        end
    ...
    elseif not(hascategories) && isvector(data)
        violins2 = Violin2(data, 1, varargin{:});
        set(gca, 'XTick', 1);
